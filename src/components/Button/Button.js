...
export default function Button({color, variant, size, boxShadow, onClick, customStyles, children}) {
  ...
  return (
    <button className={setClassNames()} style={setCustomStyles} onClick={onClick}>
      {children}
    </button>
  )
}